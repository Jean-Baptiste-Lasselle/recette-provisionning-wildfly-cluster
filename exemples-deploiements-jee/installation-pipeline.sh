...
############################################################
####	TOTU CECI DOIT ÊTRE FAIT AVEC UN DOCKERFILE
############################################################
...
clear
echo " ------------------------------------- "
echo " -- SETUP PIPELINE TERMINE "
echo " ------------------------------------- "
echo " Le pipeline est un conteneur docker, que l'on peut utiliser de la manière suivante: "
echo " 	   [sudo docker ps -a] "
echo " 	   [sudo docker exec -it pipeline /deployer-appli-exemple-1] "
echo " 	   [sudo docker exec -it pipeline /deployer-appli-exemple-2] "
echo " 	   [sudo docker exec -it pipeline /deployer-appli-exemple-3] "
echo " ------------------------------------- "
